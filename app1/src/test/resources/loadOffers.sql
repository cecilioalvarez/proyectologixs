...
insert into offer(id,code,name,description,category) values(3,'code3','name3','description3','category3');
insert into offer(id,code,name,description,category) values(4,'code4','name4','description4','category4');
insert into offer(id,code,name,description,category) values(5,'code5','name5','description5','category5');
